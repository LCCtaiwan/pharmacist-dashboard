...
const DEFAULT_SOURCES = [
  ['taiwan-pharmacy-society', '台灣藥學會－繼續教育申請', 'manual', 'https://www.pharm.org.tw/score/applyList.asp', true, 1, 360, '', '', '', '目前 GAS／IMPORTHTML 遭 HTTP 403；來源保留於彙整清單'],
  ...
  ['taichung-pharmacists', '臺中市藥師公會', 'manual', 'https://www.tccpa.org.tw/web/index.html', true, 2, 720, '', '', '', '公開公告來源'],
  ['kaohsiung-pharmacists', '高雄市藥師公會', 'manual', 'https://www.kpa.org.tw/', true, 2, 720, '', '', '', '公開公告來源'],
  ['young-pharmacists', '台灣年輕藥師協會', 'wordpress_rss', 'https://typg.org.tw/feed/', true, 3, 720, '', '', '', 'RSS 自動匯入課程'],
  ['vghtpe-pharmacy', '臺北榮總藥學部年度繼續教育', 'manual', 'https://www.vghtpe.gov.tw/pharm/images/sg/Fpage.action?fid=19142&muid=21303', true, 3, 1440, '', '', '', '公開課表來源']
];
