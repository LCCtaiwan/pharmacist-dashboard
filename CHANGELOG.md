...
- 修正公開 HTML 採集器的西元／民國日期解析，避免產生 1936 等異常年份分頁。
- 公開公告頁中的歷史封存日期不再污染課程月份資料。
- 驗證：Actions Run 11 成功；`courses.json` 為 32 堂課、8 個來源，Google Sheet 同步成功。

## v0.6.2 — 2026-08-04

### C-014 — 2026-08-04

- GitHub Actions 自動來源由 3 個擴充至 8 個：台灣藥學會消息、桃園、臺中、高雄、臺南南瀛、臺北榮總與台灣年輕藥師協會等公開頁面／RSS。
- 新增通用公開 HTML 課程連結解析器，從公開頁面自動擷取課名、日期、學分、上課方式與來源連結；不設人工審核門檻。
- 保留來源個別錯誤與上一版資料，不讓單一網站反爬或改版影響其他來源更新。
